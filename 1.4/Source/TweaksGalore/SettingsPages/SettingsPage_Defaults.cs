    ...
    public static class SettingsPage_Defaults
    {
        ...
        public static void DoSettings_Defaults(Listing_Standard listing)
        {
            ...
            if (listing.ButtonText("Mechanoids"))
            {
                ...
                Messages.Message("Tweaks Galore: 'Mechanoids' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
            ...
            if (listing.ButtonText("Penned Animals"))
            {
                ...
                Messages.Message("Tweaks Galore: 'Penned Animals' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
            ...
            if (listing.ButtonText("Royal Titles"))
            {
                ...
                Messages.Message("Tweaks Galore: 'Royal Titles' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
                TweaksGaloreMod.mod.restoreRoyalTitles = true;
            }
            if (listing.ButtonText("Royal Permits"))
            {
                DefaultUtil.RestoreSettings_RoyalTitles(settings);
                Messages.Message("Tweaks Galore: 'Royal Permits' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
                TweaksGaloreMod.mod.restoreRoyalPermits = true;
            }
            if (listing.ButtonText("Anima"))
            {
                DefaultUtil.RestoreSettings_Anima(settings);
                Messages.Message("Tweaks Galore: 'Anima' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
                TweaksGaloreMod.mod.restoreAnima = true;
            }
            if (listing.ButtonText("Ideology"))
            {
                DefaultUtil.RestoreSettings_Ideology(settings);
                Messages.Message("Tweaks Galore: 'Ideology' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
                TweaksGaloreMod.mod.restoreIdeology = true;
            }
            if (listing.ButtonText("Gauranlen"))
            {
                DefaultUtil.RestoreSettings_Gauranlen(settings);
                Messages.Message("Tweaks Galore: 'Gauranlen' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
                TweaksGaloreMod.mod.restoreGauranlen = true;
            }
            if (listing.ButtonText("Biotech"))
            {
                DefaultUtil.RestoreSettings_Biotech(settings);
                Messages.Message("Tweaks Galore: 'Biotech' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
                TweaksGaloreMod.mod.restoreBiotech = true;
            }
            if (listing.ButtonText("Polux"))
            {
                DefaultUtil.RestoreSettings_Polux(settings);
                Messages.Message("Tweaks Galore: 'Polux' tweaks restored to defaults. Restart required to take effect.", MessageTypeDefOf.CautionInput);
