...
{
    public class TweakWorker_Shuttle_MassCapacity : TweakWorker
    {
        ...
        public override void OnStartup()
        {
            ...
            {
                CompProperties_Transporter props = ThingDefOf.PassengerShuttle.GetCompProperties<CompProperties_Transporter>();
                props.massCapacity = def.IntValue;
            }
        }
