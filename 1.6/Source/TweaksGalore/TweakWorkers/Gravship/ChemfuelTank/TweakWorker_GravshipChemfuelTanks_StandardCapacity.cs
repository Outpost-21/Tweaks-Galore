...
{
    public class TweakWorker_GravshipChemfuelTanks_StandardCapacity : TweakWorker
    {
        ...
        public override void OnStartup()
        {
            ...
            {
                CompProperties_Refuelable props = ThingDefOf.ChemfuelTank.GetCompProperties<CompProperties_Refuelable>();
