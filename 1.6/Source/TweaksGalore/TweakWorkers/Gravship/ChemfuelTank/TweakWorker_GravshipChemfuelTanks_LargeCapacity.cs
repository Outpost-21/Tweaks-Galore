...
{
    public class TweakWorker_GravshipChemfuelTanks_LargeCapacity : TweakWorker
    {
        ...
        public override void OnStartup()
        {
            ...
            {
                CompProperties_Refuelable props = TGThingDefOf.LargeChemfuelTank.GetCompProperties<CompProperties_Refuelable>();
