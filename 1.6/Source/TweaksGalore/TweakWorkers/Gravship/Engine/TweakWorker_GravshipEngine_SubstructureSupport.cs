...
{
    public class TweakWorker_GravshipEngine_SubstructureSupport : TweakWorker
    {
        ...
        public override void OnStartup()
        {
            ...
            {
                ThingDefOf.GravEngine.SetStatBaseValue(StatDefOf.SubstructureSupport, def.IntValue);
            }
        }
